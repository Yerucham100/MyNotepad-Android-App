...
{
    private static final String DATABASE_NAME = "MyNotepad-2.db";
    ...
    public void onCreate(SQLiteDatabase db)
    {
        final String CREATE_NOTE_TABLE = "CREATE TABLE " + NoteContract.NoteEntries.TABLE_NAME +
                ...
                NoteContract.NoteEntries.COLUMN_TIME + " TEXT NOT NULL, " +
                NoteContract.NoteEntries.ACTUAL_TIME + " TIMESTAMP DEFAULT CURRENT_TIMESTAMP " + //TIMESTAMP DEFAULT CURRENT_TIMESTAMP
                ");";
